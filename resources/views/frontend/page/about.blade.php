        ...
        <div class="container">
            ...
            <div class="row justify-content-center mb-4">
                <div class="col-lg-8 text-center">
                    <h2 class="fw-bold display-5" style="color: #00AEEF;">About Us</h2>
                    <p class="text-muted fs-5">Dedicated to your health and well-being – Learn more about Goreto Pharmacy.
                    </p>
