                    ...
                    <div class="row g-0">
                        ...
                        <div class="col-md-7 p-5">
                            ...
                            <div id="loginSection">
                                ...
                                <div class="alert alert-danger py-2 px-3" id="loginError" role="alert"></div>
                                ...
                                <form id="loginForm">
                                    ...
                                    <div class="d-grid mb-3">
                                        <button class="btn btn-login btn-lg" type="submit">Login</button>
                                    </div>
                                    ...
                                    <div class="text-center">
                                        ...
                                        <a class="form-link fw-semibold" id="switchToRegister" href="#">Sign
                                            Up</a>
                                    </div>
                                </form>
                            </div>
                            ...
                            <div id="registerSection" style="display: none;">
                                ...
                                <form id="registerForm">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <input class="form-control form-control-lg" id="registerPassword"
                                            type="password" required placeholder="Enter a password" />
                                    </div>
