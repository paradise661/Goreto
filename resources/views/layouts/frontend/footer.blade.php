         ...
         <div class="container-fluid py-5">
             <div class="row w-100 ">
                 <div class="col-lg-3 col-sm-6  d-flex  align-lg-items-center justify-lg-content-center">
                     <div>
                         <div class="pb-3 text-start">
                             <img src="./images/logo.png" class="fotter-img" alt="logo">
                         </div>
                 ...
                 <div class="col-lg-3 col-12 mb-3 mt-lg-0 mt-3">
                     <h5 class="fotter-headings">Projects</h5>
                     <ul class="nav flex-column fotter-text fotter-css">
                         <li class="nav-item mb-2">
                             <a href="" class="nav-link p-0">Intimate Celebration Package
                             </a>
                         </li>
                         <li class="nav-item mb-2">
                         ...
                         <li class="nav-item mb-2">
                             <a href="" class="nav-link p-0">Classic Elegance Package</a>
                         </li>
                         <li class="nav-item mb-2">
                             <a href="" class="nav-link p-0">Royal Grandeur Package</a>
                         </li>
                         ...
                         <li class="nav-item mb-2">
                             <a href="" class="nav-link p-0">Premium Luxe Package</a>
                         </li>
                     </ul>
                 </div>
