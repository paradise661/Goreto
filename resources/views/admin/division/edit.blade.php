...
@section('title', 'Edit ' . $division->name . ' - Ohm Pharmaceuticals')
    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit division - {{ $division->name }}</h5>
                <small class="text-muted float-end">
                    <a class="btn btn-primary" href="{{ route('division.index') }}"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('division.update', $division->id) }}"
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('name') is-invalid @enderror" id=""
                                            type="text" name="name" value="{{ old('name', $division->name) }}"
                                            placeholder="">
                                        @error('name')
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('slug') is-invalid @enderror" id=""
                                            type="text" name="slug" value="{{ old('slug', $division->slug) }}"
                                            placeholder="">
                                        @error('slug')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control ckeditor br-8 @error('description') is-invalid @enderror" id="description"
                                    name="description" rows="10" placeholder="Enter Description">{{ old('description', $division->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            <fieldset class="border p-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control br-8" type="text" name="seo_title"
                                        value="{{ old('seo_title', $division->seo_title) }}" placeholder="Enter Seo Title">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="seo_description">Seo Description</label>
                                    <textarea class="form-control br-8" name="seo_description" rows="4" placeholder="Enter Seo Description">{{ old('seo_description', $division->seo_description) }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                    <label for="seo_keywords">Seo Keywords</label>
                                    <input class="form-control br-8" type="text" name="seo_keywords"
                                        value="{{ old('seo_keywords', $division->seo_keywords) }}"
                                        placeholder="Enter Seo Keywords">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="seo_schema">Seo Schema</label>
                                    <textarea class="form-control br-8" name="seo_schema" rows="10" placeholder="Enter Seo Schema">{{ old('seo_schema', $division->seo_schema) }}</textarea>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                        ...
                        <div class="card-body card shadow br-8">
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0" @if ($division->status == 0) selected @endif>
                                        Draft</option>
                                    <option class="p-3"@if ($division->status == 1) selected @endif value="1">
                                        Publish</option>
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3 mt-2">
                                ...
                                <div class="custom-file">
                                    <a class="feature-modal" data-bs-toggle="modal" data-bs-target="#featureModel"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($division->image)
                                                    @php
                                                        $feature = get_media($division->image ?? '');
                                                    @endphp
                                                    @if ($feature)
                                    ...
                                    <input class="" id="feature_id" type="hidden" name="image"
                                        value="{{ old('image', $division->image) }}">
                                    @error('image')
                                        <div class="invalid-feedback" style="display: block;">
                                            {{ $message }}
                                        </div>
                            ...
                            <div class="card-footers d-flex justify-content-between">
                                <a class="btn btn-sm btn-success" href="#" target="_blank"><i
