...
@section('title', 'Edit ' . $member->name . ' - Goreto')
                    ...
                    <div class="col-md-9">
                        <div class="card card-body main-description shadow br-8 p-4 mb-3">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input class="form-control br-8" type="tel" name="phone"
                                    value="{{ old('phone', $member->phone) }}" placeholder="Enter Phone">
                            </div>
                            <div class="form-group mb-3">
                                <label for="email">Email</label>
                                <input class="form-control br-8" type="email" name="email"
                                    ...
                                    <a class="feature-modal" data-bs-toggle="modal" data-bs-target="#featureModel"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($member->image)
                                                    @php
                                                        $feature = get_media($member->image ?? '');
                                                    @endphp
                                                    @if ($feature)
