...
@section('title', 'Edit ' . $blog->name . ' - Goreto')
                    ...
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            ...
                            <div class="card-footers d-flex justify-content-between">
                                <a class="btn btn-sm btn-success" href="{{ route('blogsingle', $blog->slug) }}"
                        ...
                        @include('admin.news.includes.category')
                    </div>
                </form>
            </div>
        </div>
