...
@section('title', 'Edit ' . $category->name . ' - Ohm Pharmaceuticals')
        ...
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                ...
                <small class="text-muted float-end">
                    <a class="btn btn-primary" href="{{ route('category.index') }}"><i class="fa-solid fa-arrow-left"></i>
                        Back</a>
                </small>
            </div>
            <div class="card-body p-0">
                <form class="row" method="POST" action="{{ route('category.update', $category->id) }}"
                        ...
                        <div class="card card-body main-description shadow br-8 p-4">
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control @error('slug') is-invalid @enderror" id=""
                                            type="text" name="slug" value="{{ old('slug', $category->slug) }}"
                                            placeholder="">
                                        @error('slug')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control ckeditor br-8 @error('description') is-invalid @enderror" id="description"
                                    name="description" rows="10" placeholder="Enter Description">{{ old('description', $category->description) }}</textarea>
                                @error('description')
                                    <div class="invalid-feedback" style="display: block;">
                                        {{ $message }}
                                    </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <textarea class="form-control br-8 @error('short_description') is-invalid @enderror" id="short_description"
                                    name="short_description" rows="4" placeholder="Enter short_Description">{{ old('short_description', $category->short_description) }}</textarea>
                            ...
                            <fieldset class="border p-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <input class="form-control br-8" type="text" name="seo_title"
                                        value="{{ old('seo_title', $category->seo_title) }}" placeholder="Enter Seo Title">
                                </div>
                                <div class="form-group mb-3">
                                    <label for="seo_description">Seo Description</label>
                                    <textarea class="form-control br-8" name="seo_description" rows="4" placeholder="Enter Seo Description">{{ old('seo_description', $category->seo_description) }}</textarea>
                                </div>
                                <div class="form-group mb-3">
                                ...
                                <div class="form-group mb-3">
                                    ...
                                    <textarea class="form-control br-8" name="seo_schema" rows="10" placeholder="Enter Seo Schema">{{ old('seo_schema', $category->seo_schema) }}</textarea>
                                </div>
                            </fieldset>
                        </div>
                    </div>
                    <div class="col-md-3">
                        <div class="card-body card shadow br-8">
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0" @if ($category->status == 0) selected @endif>
                                        Draft</option>
                                    <option class="p-3"@if ($category->status == 1) selected @endif value="1">
                                        Publish</option>
                                </select>
                            </div>
                                    ...
                                    <a class="feature-modal" data-bs-toggle="modal" data-bs-target="#featureModel"
                                        ...
                                        <div
                                            ...
                                            <div
                                                ...
                                                @if ($category->image)
                                                    @php
                                                        $feature = get_media($category->image ?? '');
                                                    @endphp
                                                    @if ($feature)
                        ...
                        @include('admin.category.includes.parent')
                    </div>
                </form>
            </div>
        </div>
