    ...
    <div class="content">
        <div class="card container-fluid mb-4">
            <div class="card-header d-flex justify-content-between align-items-center">
                <h5 class="mb-0">Edit Icon - {{ $social->name }}</h5>
                                ...
                                <div class="col-md-4">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control br-8 @error('icon') is-invalid @enderror" type="text"
                                            name="icon" value="{{ old('icon', $social->icon) }}"
                                ...
                                <div class="col-md-8">
                                    <div class="form-group mb-3">
                                        ...
                                        <input class="form-control br-8 @error('link') is-invalid @enderror" type="text"
                                            name="link" value="{{ old('link', $social->link) }}" placeholder="Enter Url">
                                        @error('link')
                                            <div class="invalid-feedback" style="display: block;">
                                                {{ $message }}
                                            </div>
                        ...
                        <div class="card-body card shadow br-8">
                            <div class="form-group mb-3 d-flex align-items-center">
                                ...
                                <select class="form-select ms-5" id="status" name="status">
                                    <option class="p-3" value="0" @if ($social->status == 0) selected @endif>
                                        Draft</option>
                                    <option class="p-3"@if ($social->status == 1) selected @endif value="1">
                                        Publish</option>
                                </select>
                            </div>
