...
class DatabaseSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $items = [
            ...
            ['site_email_two', 'admin@goreto.com'],
            ...
            ['site_topbar', 'Goreto'],
            ['site_copyright', 'Goreto'],

            ['homepage_title', 'Goreto'],
            ['homepage_image', null],
            ['homepage_description', 'Goreto'],
            ['homepage_seo_title', 'Goreto'],
            ['homepage_seo_description', 'Goreto'],
            ['homepage_seo_keywords', 'Goreto'],
            ...
            ['team_title', 'Goreto'],
            ['team_description', 'Goreto'],

            ['blog_title', 'Our Blogs'],
            ['blog_description', 'Goreto'],
        ];
        ...
        if (!User::where('email', 'admin@goreto.com')->exists()) {
            User::create([
                'name' => 'Super Admin',
                'email' => 'admin@goreto.com',
